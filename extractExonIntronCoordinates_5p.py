...
for key, item in data_5p_groupedByTranscript:
    
    coords_key = data_5p_groupedByTranscript.get_group(key)
...
new_geneNameDF.to_csv("../data/ExonIntronCoords_GeneNameTranscriptID_NCBI_RefSeq_hg38_FromGFFfile_5p.tsv",sep="\t",header=False,index=False)
