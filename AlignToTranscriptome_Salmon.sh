...
# salmon index -t ExtractedExonIntronCoordinates_5p_FromGFFfile_ForSequence.fa -i ExtractedExonIntronCoordinates_5p_FromGFFfile_sequences_index --type quasi -k 31

# salmon index -t ExtractedExonIntronCoordinates_3p_FromGFFfile_ForSequence.fa -i ExtractedExonIntronCoordinates_3p_FromGFFfile_sequences_index --type quasi -k 31

# salmon index -t Unique_ExtractedExonIntronCoordinates_5p_FromGFFfile_ForSequence.fa -i Unique_ExtractedExonIntronCoordinates_5p_FromGFFfile_sequences_index --type quasi -k 31

# salmon index -t Unique_ExtractedExonIntronCoordinates_3p_FromGFFfile_ForSequence.fa -i Unique_ExtractedExonIntronCoordinates_3p_FromGFFfile_sequences_index --type quasi -k 31

# salmon index -t Unique_ExtractedExonIntronCoordinates_5p_FromGFFfile_ForSequence_Just5p.fa -i Unique_ExtractedExonIntronCoordinates_5p_FromGFFfile_sequences_index_Just5p --type quasi -k 31

# salmon index -t Unique_ExtractedExonIntronCoordinates_3p_FromGFFfile_ForSequence_Just3p.fa -i Unique_ExtractedExonIntronCoordinates_3p_FromGFFfile_sequences_index_Just3p --type quasi -k 31
...
do
    ...
    salmon quant -i ${datafolder}/Unique_ExtractedExonIntronCoordinates_5p_FromGFFfile_sequences_index_Just5p -l A -1 ${fastafolder}/${realNameFile}L001_R1_001.fastq -2 ${fastafolder}/${realNameFile}L001_R2_001.fastq -p 12 -g ${datafolder}/ExonIntronCoords_GeneNameTranscriptID_NCBI_RefSeq_hg38_FromGFFfile_5p.tsv -o ${realNameFile}transcripts_quant_genenames_AgainstUnique5pExonIntronBoundaryCoordinates
    salmon quant -i ${datafolder}/Unique_ExtractedExonIntronCoordinates_3p_FromGFFfile_sequences_index_Just3p -l A -1 ${fastafolder}/${realNameFile}L001_R1_001.fastq -2 ${fastafolder}/${realNameFile}L001_R2_001.fastq -p 12 -g ${datafolder}/ExonIntronCoords_GeneNameTranscriptID_NCBI_RefSeq_hg38_FromGFFfile_3p.tsv -o ${realNameFile}transcripts_quant_genenames_AgainstUnique3pExonIntronBoundaryCoordinates
