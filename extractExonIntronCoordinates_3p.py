...
for key, item in data_3p_groupedByTranscript:
    
    coords_key = data_3p_groupedByTranscript.get_group(key)
...
new_geneNameDF.to_csv("../data/ExonIntronCoords_GeneNameTranscriptID_NCBI_RefSeq_hg38_FromGFFfile_3p.tsv",sep="\t",header=False,index=False)
...
#all_5p_ExonIntronCoords_ToWrite_Sorted.to_csv("../data/ExtractedExonIntronCoordinates_5p_FromGFFfile_ForSequence_Just5p.bed",sep="\t",header=False,index=False)
...
all_3p_ExonIntronCoords_ToWrite_Sorted.to_csv("../data/ExtractedExonIntronCoordinates_3p_FromGFFfile_ForSequence_Just3p.bed",sep="\t",header=False,index=False)